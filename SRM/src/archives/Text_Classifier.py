...
class Text_Classsifier:
    ...
    def loadTextFields(self , df , text_fields):
    ...
    def loadTrainingData(self, trainingFilePath , text_fields , labelCol , mask =[]):
        ...
        self.text = self.loadTextFields(df, text_fields)
...
#          ])
    ...
    def loadTestDataFromFile(self , testDataFilePath , text_fields , mask=[]):
...
#
        ...
        return  self.loadTextFields(df_sub, text_fields) , df
    
    def loadTestDataFromDataFrame(self , dataFrame , text_fields , mask=[]):
        
        dataFrame_sub = self.performMasking(dataFrame, mask)
            
        return  self.loadTextFields(dataFrame_sub, text_fields) 
